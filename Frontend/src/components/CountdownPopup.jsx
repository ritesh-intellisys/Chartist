  ...
  return (
    <AnimatePresence>
      {isVisible && (
        ...
        >
          <motion.div
            className="relative bg-gradient-to-br from-gray-900 via-black-900 to-blue-900 rounded-2xl p-8 max-w-6xl w-full shadow-2xl border border-purple-400 overflow-hidden"
